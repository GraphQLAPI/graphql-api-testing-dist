...
class ModuleSettingsAdminRESTController extends AbstractAdminRESTController
{
    ...
    final protected function getSettingsNormalizer(): SettingsNormalizerInterface
    {
        ...
        return $this->settingsNormalizer = $this->settingsNormalizer ?? InstanceManagerFacade::getInstance()->getInstance(SettingsNormalizerInterface::class);
    }
     ...
     * @param string $jsonEncodedOptionValues
     * @param \WP_REST_Request $request
     */
    protected function validateOptions($jsonEncodedOptionValues, $request)
    {
        ...
        if ($optionValues === null) {
            return new WP_Error(
                '1',
                sprintf(__('Property \'%s\' is not JSON-encoded properly', 'graphql-api-testing'), Params::JSON_ENCODED_OPTION_VALUES),
                [
                    Params::STATE => [
     ...
     */
    protected function shouldFlushRewriteRules($optionValues): bool
    {
